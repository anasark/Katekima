  ...
  <div class="relative overflow-x-auto sm:rounded-lg">
    ...
    <div v-else>
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody v-if="detail">
          <tr v-for="(value, key) in detail" :key="key" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
